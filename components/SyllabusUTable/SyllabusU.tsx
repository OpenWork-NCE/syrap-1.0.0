...
const Section = () => {
    ...
    () => [
      ...
      },
      {
        ...
        mantineEditSelectProps: (props) => {
          ...
          const modules = structuredData
            .find((u: any) => u.university === row.original.university)
      ...
      },
      {
        ...
        mantineEditSelectProps: (props) => {
          ...
          const branches =
            structuredData.find(
              (u: any) => u.university === row.original.university,
            )?.branches ?? [];
  ...
  const table = useMantineReactTable({
    ...
    initialState: {
      density: 'md',
      grouping: ['university', 'branch', 'level'],
      columnVisibility: {
        id: false,
        slug: false,
        description: false,
