...
export const fakeData: University[] = [
  ...
  {
    id: '15',
    name: 'Institut Supérieur des Technologies et du Design Industriel',
    phone: '+237 677 99 99 99',
    email: 'istdi@istdi.cm',
    borough: 'Douala',
    created_user: 'Georges Djoumessi',
  },
  {
    id: '16',
    name: 'African Institute for Mathematical Sciences (AIMS-Cameroon)',
    phone: '+237 677 00 00 00',
    email: 'aims@nexteinstein.org',
    borough: 'Limbé',
  ...
  },
  {
    ...
    phone: '+250 788 30 87 00',
    email: 'africa@cmu.edu',
    borough: 'Kigali, Rwanda',
  ...
  {
    id: '25',
    name: 'Université de Californie à Berkeley',
    phone: '+1 510 642-6000',
    email: 'info@berkeley.edu',
    borough: 'Douala',
    created_user: 'Quentin Essomba',
  },
];
