...
import { SyllabusTable } from '@/components';
...
type LevelsUniversityTableProps = {
      ...
      >
        <Box style={{ width: '100%' }}>
          ...
          <Box style={{ fontSize: '16px' }}>
            ...
            <Divider pb={1} mb={10} />
            <Title order={5} mb={5}>
              Programme de niveau {row.original.name}
            </Title>
            <SyllabusTable />
            <Button my={10} leftSection={<IconBook />} onClick={() => {}}>
...
const LevelsUniversityTable = ({ datas }: LevelsUniversityTableProps) => (
...
export default LevelsUniversityTable;
