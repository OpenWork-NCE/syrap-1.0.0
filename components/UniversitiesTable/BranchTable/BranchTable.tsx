...
import { type BranchContext } from '@/components/UniversitiesTable/BranchTable/makeData';
import { type Branch } from '@/types';
import { jsPDF } from 'jspdf'; //or use your library of choice here
import autoTable from 'jspdf-autotable';
import { mkConfig, generateCsv, download } from 'export-to-csv';
import { LevelsUniversityTable, LevelTable } from '@/components';
...
type BranchesUniversityTableProps = {
  datas: Branch[];
};
...
const BranchesUniversityTable = ({ datas }: BranchesUniversityTableProps) => (
...
export default BranchesUniversityTable;
