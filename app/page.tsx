...
import FirstLayout from '@/app/authentication/layout';
import SingInLayout from '@/app/authentication/signin/layout';
...
export default function Home() {
  return (
    <>
      ...
      {/*        <Stack>*/}
      {/*          <Text>SYCEP - Système de Centration des Programmes</Text>*/}
      {/*          <Title className={classes.title}>*/}
      {/*            Plateforme de Centralisation des Programmes de Formations des*/}
      {/*            IPES au Cameroun.*/}
